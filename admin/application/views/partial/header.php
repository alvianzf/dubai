								...
								<ul class="side-header-nav">
									<li class="with-dropdown active">
										...
										<ul class="menu-dropdown collapse">
										    <li><a href="<?php echo base_url();?>Home/User">Change Password</a></li>
											<li><a href="<?php echo base_url(). 'AdminLogin/logOut'; ?>">logout</a></li>	</ul>
									...
									<li class="with-dropdown">
										...
										<ul class="menu-dropdown collapse">
											...
											<li><a href="<?php echo base_url();?>Home/Siteinfo">Site Info</a></li>
											<li><a href="<?php echo base_url();?>Home/Sidebar">Sidebar</a></li>
											<li><a href="<?php echo base_url();?>Home/CustomSite">Custom Site</a></li>
										</ul>
									</li>
								</ul>
