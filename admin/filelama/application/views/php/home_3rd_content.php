										...
										<tr>
											...
											<td style="text-align:center;"> <?php echo $rsql['tanggal']; ?></td>
										 	...
										 	<td style="text-align:center;"><?php echo $rsql['hasil_3']; ?></td>
										  	...
										  	<td style="text-align:center;"><a href="<?php echo base_url(); ?>Home/editResult3rd/<?php echo $rsql['hasil_id']; ?>">Edit</a><a href="<?php echo base_url(); ?>Home/deleteResult3rd/<?php echo $rsql['hasil_id']; ?>" onclick="return confirm('Are You Sure To Delete')"> Delete</a></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
