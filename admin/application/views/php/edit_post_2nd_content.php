						...
						<div class="panel panel-default">
							...
							<div id="collapse4" class="panel-collapse collapse in">
								<div class="panel-body">
									<!-- Form Simple - Grey -->
								<form id="myForm" class="form-theme form-line" action="<?php echo base_url(); ?>Home/editResult2ndSubmit" method="post">
									...
									<div class="row pad-top-30">
										<div class="col-sm-2">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="hasil_1" maxlength="6" required="" value="<?php echo $product_data->hasil_1; ?>"/>
											</div>
										</div>
										...
										<div class="col-sm-2">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="hasil_2" maxlength="6" required="" value="<?php echo $product_data->hasil_2; ?>"/>
											</div>
										</div>
										...
										<div class="col-sm-2">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="hasil_3" maxlength="6" required="" value="<?php echo $product_data->hasil_3; ?>"/>
											</div>
										</div>
